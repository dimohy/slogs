    ...
    private sealed class ContractHandler : HttpMessageHandler
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            var json = request.RequestUri?.AbsolutePath switch
            {
                "/info" =>
                    """
                    {"modelId":"BAAI/bge-m3","modelRevision":"5617a9f61b028005a4858fdac845db406aefb181","dimensions":1024,"encodeBatchSize":1,"scoreBatchSize":8,"encodeLockSliceSize":4,"concurrentGpuRequests":1,"priorityScheduling":true,"functions":["dense","sparse","multi-vector","pair-score"]}
                    """,
